...
static struct msm_camera_i2c_reg_conf hi258_preview_settings[] = {
	...
	{0x8D, 0xd3}, //EXP120 
	{0x8E, 0x95}, 
	{0x9c, 0x1b}, //EXP Limit 920.03 fps 
	{0x9d, 0x99}, 
	{0x9e, 0x01}, //EXP Unit 
	{0x9f, 0xd7}, 
	{0xa3, 0x00}, //Outdoor Int 
...
static struct msm_camera_i2c_reg_conf hi258_recommend_settings[] = {
    ...
    {0x75, 0x00},//{0x75, 0x60}, //Sat over th
    {0x76, 0x05}, //White Protection Enable
    {0x78, 0xdf},//{0x78, 0xff}, //Sat over ratio
    ///// PAGE 10 END /////
    ...
    {0x22, 0x7f},//   {0x22, 0x78}, //LSC R 1b->15 20130125
    {0x23, 0x68}, //LSC G
    {0x24, 0x68}, //LSC B
    ...
    {0xb8, 0x90}, //(0+,1-)High Cb , (0+,1-)Low Cr
    {0xb9, 0x30},
    /////// PAGE 22 END ///////
...
static int __init hi258_init_module(void)
{
	int32_t rc;
	pr_err("%s:%d\n", __func__, __LINE__);
	rc = platform_driver_register(&hi258_platform_driver);
	if (!rc)
		return rc;
	...
	case CFG_SET_RESOLUTION:
		{
			...
			if (res == MSM_SENSOR_RES_FULL) {
				...
				rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
					...
					MSM_CAMERA_I2C_BYTE_DATA);
				pr_err("%s:%d res =%d hi258_480p_settings\n",
					 __func__, __LINE__, res);
			} else {
...
static struct msm_sensor_ctrl_t hi258_s_ctrl = {
	...
	.power_setting_array.power_down_setting = hi258_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(hi258_power_down_setting),
